    ...
    <div className="max-w-4xl mx-auto">
      ...
      <form onSubmit={handleSubmit} className="space-y-6">
        ...
        <div className="flex justify-between items-center">
          ...
          >
            <span className={`transition-opacity ${isGenerating ? 'opacity-0' : 'opacity-100'}`}>
          ...
          <>
            ...
            <div className="flex items-center justify-between">
              ...
              <button
                type="submit"
                disabled={isSaving}
                className={`btn-primary relative ${isSaving ? 'opacity-50 cursor-not-allowed' : ''}`}
              >
                <span className={`transition-opacity ${isSaving ? 'opacity-0' : 'opacity-100'}`}>
                  <span className="mr-2">📝</span>
                  Publish Post
                </span>
                {isSaving && (
