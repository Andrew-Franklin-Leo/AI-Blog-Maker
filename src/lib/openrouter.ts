      ...
      messages: [
        {
          role: "system",
          content:
            "You are a skilled writer helping to create authentic blog posts about personal growth and experiences.",
        },
        {
          role: "user",
  ...
  try {
      ...
      messages: [
        {
          role: "system",
          content:
            "Analyze the blog post and extract metadata. Respond with ONLY a JSON object containing tags (array of 3-5 relevant keywords), category (general topic), and readTime (estimated minutes to read).",
        },
        {
          role: "user",
          content: content,
    ...
    try {
      ...
      return {
        ...
        readTime:
          analysis.readTime || Math.ceil(content.split(" ").length / 200),
      };
    } catch (e) {
