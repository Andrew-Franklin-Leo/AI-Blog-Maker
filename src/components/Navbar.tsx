  ...
  return (
    <nav className="bg-white dark:bg-gray-800 shadow-sm relative">
      <a
        ...
        className="sr-only focus:not-sr-only focus:absolute focus:z-[60] focus:top-0 focus:left-0 focus:right-0 focus:bg-blue-600 focus:text-white focus:py-2 focus:text-center focus:font-medium"
      >
        Skip to content
      </a>
