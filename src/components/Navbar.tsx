...
const Navbar = () => {
  const navLinkClass = ({ isActive }: { isActive: boolean }) => {
    const baseClasses = "px-1 py-2 text-sm font-medium transition-colors duration-200 border-b-2 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-blue-500 rounded-sm"
    return isActive
    ...
    <nav className="bg-white dark:bg-gray-800 shadow-sm sticky top-0 z-50">
      ...
      <div className="container mx-auto px-4">
        <div className="flex items-center justify-between h-16">
          <Link to="/" className="text-xl font-bold text-gray-900 dark:text-white focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-blue-500 rounded-md px-1">
            Li Xia&apos;s Blog
          </Link>
