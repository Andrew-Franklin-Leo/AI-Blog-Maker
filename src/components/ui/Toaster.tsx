...
export const Toaster: React.FC = () => {
  ...
  return (
    <div className="fixed top-0 right-0 p-4 w-full sm:max-w-md z-50 space-y-4">
      {toasts.map((toast) => (
        <div
          key={toast.id}
          className={`flex items-start p-4 rounded-lg shadow-lg border-l-4 toast-enter ${
        ...
        >
          ...
          <div className="ml-4 flex-shrink-0 flex">
            <button
              ...
              className="inline-flex rounded-md hover:bg-black/5 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-offset-transparent"
            >
