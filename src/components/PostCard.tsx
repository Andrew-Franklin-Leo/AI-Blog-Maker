...
const PostCard = ({
  ...
  return (
    <article className="bg-white dark:bg-gray-800 rounded-lg shadow-md overflow-hidden transition-shadow hover:shadow-lg focus-within:ring-2 focus-within:ring-blue-500">
